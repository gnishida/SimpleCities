...
public:
    ...
    void setupUi(QDockWidget *ControlWidget)
    {
        ...
        lineEditSetbackRear->setGeometry(QRect(140, 140, 71, 20));
        ...
        lineEditNumStories->setGeometry(QRect(140, 20, 71, 20));
        ...
        lineEditNumStoriesDev->setGeometry(QRect(140, 50, 71, 20));
        ...
        lineEditMinBuildingDim->setGeometry(QRect(140, 80, 71, 20));
