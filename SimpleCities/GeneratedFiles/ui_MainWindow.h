...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/MainWindow/Resources/Save_24x24.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSaveTerrain->setIcon(icon2);
        ...
        actionClearRoads->setObjectName(QStringLiteral("actionClearRoads"));
